...
model.train()
model.init_EDampls(Nx*Ny-N_tot, bounds_y, bounds_y, params["t"], params["Jp"], params["Jz"])

if load_model:
    print("check if ../square/"+fol+"model_params"+fol_ext+".pt exists.")
    if os.path.exists("../square/"+fol+"model_params"+fol_ext+".pt"):
        print("load ../square/"+fol+"model_params"+fol_ext+".pt")
        model.load_state_dict(torch.load("../square/"+fol+"model_params"+fol_ext+".pt")) 
