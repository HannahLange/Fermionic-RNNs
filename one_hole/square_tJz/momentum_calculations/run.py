...
if load_model:
    print("check if ../"+fol+"model_params"+fol_ext+"_no_antisym_2.pt exists.")
    if os.path.exists("../"+fol+"model_params"+fol_ext+"_no_antisym_2.pt"):
        print("load ../"+fol+"model_params"+fol_ext+"_no_antisym_2.pt")
        model.load_state_dict(torch.load("../"+fol+"model_params"+fol_ext+"_no_antisym_2.pt")) 
        T0 = 0
        fol_ext += "_pretrained"
