...
params, density, Nx, Ny, bounds_x, bounds_y, load_model, sz_total, sym_, antisym, hiddendim, seed = parse_input(parser, H)
N_tot  = int(Nx*Ny*density)

# ---------- initial settings --------------
device = initialize_torch(seed)
