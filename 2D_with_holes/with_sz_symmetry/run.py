...
if load_model:
    if os.path.exists("../without_symmetries/"+fol+"model_params_h="+str(hiddendim)+".pt"):
        print("Load from "+"../without_symmetries/"+fol+"model_params_h="+str(hiddendim)+".pt")
        model.load_state_dict(torch.load("../without_symmetries/"+fol+"model_params_h="+str(hiddendim)+".pt"))    
...
while epoch <= num_epochs:
    ...
    if load_model and epoch > warmup_steps+annealing_steps/2: 
