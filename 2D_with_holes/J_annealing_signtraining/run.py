...
while epoch <= num_epochs:
    ...
    if epoch < signtraining_steps or (epoch<4*signtraining_steps and epoch >3*signtraining_steps) or (epoch<6*signtraining_steps and epoch >5*signtraining_steps)  or (epoch<8*signtraining_steps and epoch >7*signtraining_steps):
        signtraining = True
    else:
